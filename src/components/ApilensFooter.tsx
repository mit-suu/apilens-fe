...
export default function ApilensFooter() {
  return (
    <footer className="apilens-footer border-t border-[var(--border)] px-5 py-10">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-8 lg:grid-cols-[320px_minmax(0,1fr)]">
<StyledWrapper>
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">ApiLens </span>
            <span className="text">Detect API design issues and improve REST quality.</span>
          </div>
        ...
        <div className="flex flex-col gap-8 text-sm text-[var(--muted)] md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="eyebrow mb-3">Repository intelligence</p>
            <h2 className="text-2xl font-semibold tracking-tight text-[var(--text)]">
              API review without digging through every file by hand.
            </h2>
            <p className="mt-3 leading-6">
              APILens connects to GitHub, finds supported API files, runs an
              analysis pipeline, and keeps previous scans available for review.
            </p>
          </div>

          <div className="grid min-w-[220px] grid-cols-2 gap-6 sm:grid-cols-3">
            <div>
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--text)]">
                Product
              </p>
              <div className="flex flex-col gap-2">
                <Link href="/app" className="transition hover:text-[var(--text)]">
                  New scan
                </Link>
                <Link
                  href="/app/history"
        ...
        <div className="border-t border-[var(--border)] pt-5 text-xs uppercase tracking-widest text-[var(--subtle)] lg:col-span-2">
          © 2026 APILens. Built for developers reviewing APIs.
        </div>
      </div>
    </footer>
  );
